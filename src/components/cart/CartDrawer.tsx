                          ...
                          <div className="flex flex-col flex-1 justify-between py-0.5">
                            <div className="flex justify-between items-start gap-2">
                              <div className="flex flex-col">
                                <Link href={`/products/${item.productId}`} onClick={closeCart} className="text-sm font-bold font-heading text-ink hover:text-primary transition-colors line-clamp-1 leading-tight">
                                  {item.product?.name}
                                </Link>
