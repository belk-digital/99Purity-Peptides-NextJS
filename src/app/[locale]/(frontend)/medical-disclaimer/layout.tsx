...
const title = 'Medical Disclaimer | 99 Purity Peptides'
const description = 'All content and products from 99 Purity Peptides are for research use only. Not for human or veterinary use, diagnosis or treatment.'
